...
// You must provide the correct change to each customer so that the net transactio
//n is that the customer pays $5. 
//
// Note that you do not have any change in hand at first. 
//
// Given an integer array bills where bills[i] is the bill the ith customer pays
//, return true if you can provide every customer with the correct change, or fals
//e otherwise. 
//
// 
// Example 1: 
...
public class Q860LemonadeChange {
    ...
    public static void main(String[] args) {
        ...
        boolean result = solution.lemonadeChange(new int[]{5, 5, 10, 10, 20});
    }
